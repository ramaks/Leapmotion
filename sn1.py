...
##                    if finger.id==tempid:
##                        right_thumb_x = int(finger.tip_position[0])
##                        rt_dir_x=float(finger.direction[0])
##                        right_thumb_y = int(finger.tip_position[1])
##                        rt_dir_y=float(finger.direction[1])
##                        right_thumb_z = int(finger.tip_position[2])
##                        rt_dir_z=float(finger.direction[2])
##                        print 'rt',rt_dir_y
##                        #print finger.tip_position
##                    if finger.id==tempid+1:
##                        right_index_x = int(finger.tip_position[0])
##                        ri_dir_x=float(finger.direction[0])
##                        right_index_y = int(finger.tip_position[1])
##                        ri_dir_y=float(finger.direction[1])
##                        right_index_z = int(finger.tip_position[2])
##                        ri_dir_z=float(finger.direction[2])
##                        #,(right_thumb_y-right_index_y)
##                        print 'ri',ri_dir_y
##                        #print finger.tip_position
##                    if finger.id==tempid+2:
##                        right_middle_x = int(finger.tip_position[0])
##                        rm_dir_x=float(finger.direction[0])
##                        right_middle_y = int(finger.tip_position[1])
##                        rm_dir_y=float(finger.direction[1])
##                        right_middle_z = int(finger.tip_position[2])
##                        rm_dir_z=float(finger.direction[2])
##                         #print right_index
##                         #print finger.tip_position     
##                    if finger.id==tempid+3:
##                        right_ring_x = int(finger.tip_position[0])
##                        rr_dir_x=float(finger.direction[0])
##                        right_ring_y = int(finger.tip_position[1])
##                        rr_dir_y=float(finger.direction[1])
##                        right_ring_z = int(finger.tip_position[2])
##                        rr_dir_z=float(finger.direction[2])
##                         
##                         #print right_ring
##                         #print finger.tip_position
##                    if finger.id==tempid+4:
##                        right_pinky_x = int(finger.tip_position[0])
##                        rp_dir_x=float(finger.direction[0])
##                        right_pinky_y = int(finger.tip_position[1])
##                        rp_dir_y=float(finger.direction[1])
##                        right_pinky_z = int(finger.tip_position[2])
##                        rp_dir_z=float(finger.direction[2])
##                         
##                         #print right_pinky
##                         #print finger.tip_position
######################################################################                
            ...
            if hand.is_right:             
                        ...
                        print rt_dir_x,  ri_dir_x , rm_dir_x , rr_dir_x,rp_dir_x
                        #print right_index_y-right_thumb_y
                           # print "a"
